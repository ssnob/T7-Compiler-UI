...
ForceHostToggle()
{
    if(self GetToggleState("Force Host"))
    {
...
award_bgb(bgb)
{
    self thread bgb::func_b107a7f3(bgb, 0);
...
ScoreStreaksForever()
{
    while(self GetToggleState("Infinite Scorestreaks"))
    {
        self globallogic_score::_setplayermomentum(self, 20000);
        wait .025;
    }
}
#endif